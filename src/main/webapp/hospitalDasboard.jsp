...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="addhospital" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Hospital</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
		  ...
		  String query = "select * from project.hospital";
		  
		  ResultSet rs = con.createStatement().executeQuery(query); 
		  while(rs.next()){%>
								<tbody>
									<tr>
										<td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""><%=rs.getString("hospitalname") %></td>
        ...
        <form action="hospitaldashboard1" method="post">

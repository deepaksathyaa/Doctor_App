...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="addlab" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Lab</a>
                    </div>
                </div>
                <%
							try
		  ...
		  String query = "select * from project.labtester";
		  ...
		  while(rs.next()){%>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="profile.html"><%=rs.getString("Testlabname") %></a></h4>
                            <div class="doc-prof"><%=rs.getString("email") %></div>
                           
                                <i class="fa fa-map-marker"></i> <%=rs.getString("Phnumber") %>
                            </div>
                        </div>
                    </div>
                
                <form action="labdashboard1" method="post">
                <div id="delete_doctor" class="modal fade delete-modal" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						<img src="assets/img/sent.png" alt="" width="50" height="46">
						<h3>Are you sure want to delete this Lab?</h3>
